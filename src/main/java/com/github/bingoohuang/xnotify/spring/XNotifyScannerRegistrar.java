...
public class XNotifyScannerRegistrar implements ImportBeanDefinitionRegistrar, ResourceLoaderAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        val annoAttrs = AnnotationAttributes.fromMap(importingClassMetadata.getAnnotationAttributes(XNotifyScan.class.getName()));
        val scanner = new XNotifyClassPathScanner(registry);
